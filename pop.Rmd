...
My sister, Nassim, is a singer/songwriter who lives in Los Angeles and is much cooler than me. For some reason she values my feedback and sometimes she sends me her songs. </br>
...
<blockquote>
  Gol: I like your sad songs about heartbreak and other life challenges. </br>
...
</br>This is a tibble (a quick look) at the dataset that has the lyrics from the Billboard Top 100 Songs from 1965 - 2015. For this analysis, I use the "tidyverse" and "tidytext" r packages. 
```{r lyrics}
lyrics
```
...
</br>Now for fun, I visualized the words in a hot pink world cloud :) I used the "wordcloud" r package. Not suprisingly, LOVE is a popular concept to write about!
...
</br> Again, for fun, I made a word cloud of positive and negative sentiment words. Again, LOVE is a big word!
```{r, message = FALSE}
lyrics.tidy %>%
	inner_join(get_sentiments("bing")) %>%
